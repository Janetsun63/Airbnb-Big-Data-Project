...
def main(inputs, output):
    ...
    # remove line break
    comments = comments.withColumn('comments', regexp_replace('comments', '<br/>', ''))
    # lowercase comments
    ...
    sentiment = sentiment.withColumn('polarity', sentiment["polarity"].cast(types.DecimalType(32,18)))
    score = sentiment.withColumn('score', ((sentiment["polarity"]+1)*2.5))

    outfile = score.select('id', 'listing_id','reviewer_id', 'comments', 'score')
